...
int main()
{
	...
	printf("Bubble sort on %d elements took %f seconds to execute.", SMALL_ARRAY, time_taken1);
	...
	printf("Bubble sort on %d elements took %f seconds to execute.", SMALL_ARRAY, time_taken2);
	...
	printf("Bubble sort on %d elements took %f seconds to execute.", SMALL_ARRAY, time_taken3);
	...
	printf("Bubble sort on %d elements took %f seconds to execute.", SMALL_ARRAY, time_taken4);
	...
	printf("Bubble sort on %d elements took %f seconds to execute.", SMALL_ARRAY, time_taken5);
	...
	printf("Bubble sort on %d elements took %f seconds to execute.", SMALL_ARRAY, time_taken6);
	...
	printf("Bubble sort on %d elements took %f seconds to execute.", SMALL_ARRAY, time_taken7);
	...
	printf("Bubble sort on %d elements took %f seconds to execute.", SMALL_ARRAY, time_taken8);
	...
	printf("Bubble sort on %d elements took %f seconds to execute.", SMALL_ARRAY, time_taken9);
